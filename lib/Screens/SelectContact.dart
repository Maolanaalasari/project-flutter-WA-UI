...
import 'package:test_wa_ui/CustomUI/ButtonCard.dart';
import 'package:test_wa_ui/CustomUI/ContactCard.dart';
import 'package:test_wa_ui/Model/ChatModel.dart';
import 'package:test_wa_ui/Screens/CreateGroup.dart';
            ...
            return InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CreateGroup(key: UniqueKey()),
                  ),
                );
              },
              child: ButtonCard(
